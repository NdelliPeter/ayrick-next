...
export const faqs: { q: L; a: L }[] = [
  ...
  {
    q: {
      en: "Can you help with permits or approvals?",
      fr: "Pouvez-vous aider pour les permis et autorisations ?",
    },
    a: {
...
export const studio = {
  ...
  credentials: [
    {
      label: { en: "Years in practice", fr: "Années de pratique" },
      value: { en: "Over 18 years", fr: "Plus de 18 ans" },
    },
    { label: { en: "Projects completed", fr: "Projets réalisés" }, value: { en: "80", fr: "80" } },
    {
      label: { en: "Established", fr: "Fondation" },
      value: { en: "Ghana, 2023", fr: "Ghana, 2023" },
    },
